...
int preDayCnt = Integer.parseInt(request.getParameter("pre_day_cnt"));
String patternAtype = request.getParameter("pattern_atype");

//=== オブジェクトにセット ===
PatternDetail pd = new PatternDetail();
pd.setPatternCd(patternCd);
pd.setSeqId(seqId);
pd.setMarketCd(marketCd);
pd.setPreDayCnt(preDayCnt);
pd.setPatternAtype(patternAtype);
