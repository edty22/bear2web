...
<form name="form1" action="update_pattern_detail_exe.jsp" method="post">
		...
		<td width="500">
			...
			<table bgcolor="#9999CC" width="95%">
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<input type="text" name="seq_id" size="20" value=<%= seqId %>>
					</td>
				</tr>
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<input type="text" name="pre_day_cnt" size="20" value="<%= pd.getPreDayCnt()  %>" >
					</td>
				</tr>
